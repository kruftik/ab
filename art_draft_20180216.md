...
Так получилось и одном новом перспективном проекте в Уральской Дирекции ИТ, в которой удалось в весьма сжатые сроки реализовать полный _пайплайн_ от публикации изменений исходников в системе контроля версия разработчиком до автоматического перезапуска приложения в тестовой среде.
